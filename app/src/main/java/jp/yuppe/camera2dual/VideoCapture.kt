...
class VideoCapture(context: Context, cameraDevice: CameraDevice, textureView: TextureView, previewSize: Size) {
    ...
    fun takePhoto(rotation: Int) {
        ...
        imageCapture = ImageCapture(context, previewSize, handler)
    ...
    private fun setupMediaRecorder(context: Context, videoSize: Size) {
        ...
        mediaRecorder.setVideoEncodingBitRate(10_000_000/10)
        mediaRecorder.setOrientationHint(90) // add
    ...
    private fun startWorkerThread() {
        val threadName = cameraDevice.id
